...
This static inspection runs in a separate Python process and produces a coverage
report, not an assertion of rules accuracy. The separate hsbrsim_data bridge may
import the verified pinned dependency for explicitly scoped recruitment fixtures.
A registered script is evidence of code presence only.
"""
